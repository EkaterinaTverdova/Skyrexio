...
public class LoginTest extends BaseTest {
    ...
    public void loginTest() {
        ...
        assertEquals(browser.findElement(By.cssSelector("[data-test='title']")).getText(),
                "Products", "Не верный заголовок");
    }
    ...
    public void incorrectLoginTest() {
        ...
        assertEquals(browser.findElement(By.cssSelector("[data-test='error']")).getText(),
                "Epic sadface: Sorry, this user has been locked out.", "Не верное текст сообщения об ошибке");
    }
}
